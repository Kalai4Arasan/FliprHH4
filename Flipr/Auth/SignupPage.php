		...
		<div class="col-md-12">
			<div class="row">
				...
				<div style="margin:5px;margin-top:5%;border-radius:8px;"  class="col-md-4 box-shadow">
					<form style="margin:50px;" action="./register.php" method="POST" role="form">
                    <h3 class="text-center">
                        ...
                        <div class="form-group">
							<input name="phone" placeholder="Mobile Number" class="form-control"  required/>
						</div>
						<div class="form-group">
                        ...
                        ?>
						<button style="width: 50%; margin: 0 27%;" type="submit" class="btn btn-success">
							Signup
						</button>
                        <p><a class="lead mt-2 ml-3 text-center text-success">Already you have an account! <a href="./LoginPage.php">Login</a>
						</p>
					</form>
